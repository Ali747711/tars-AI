...
// WebGL enum values. The unused members of the set are kept for reference but
// commented out to satisfy this project's `noUnusedLocals`:
//   NearestMipMapLinearFilter = 9986, LinearMipMapNearestFilter = 9985,
//   NearestMipMapNearestFilter = 9984, MirroredRepeatWrapping = 33648
